...
interface GraphContextType {
  ...
  createNode: (params: CreateRegionSetParams) => Promise<CreateRegionSetResult>
  createEdge: (params: CreateRegionSetParams) => Promise<CreateRegionSetResult>
  updateGraph:(params:EditGraphParams)=>Promise<EditGraphResult>
  removeGraph: (params: RemoveGraphParams) => Promise<void>
  copyGraph:(params:CopyRegionSetParams)=>Promise<TrackRegionSet>
